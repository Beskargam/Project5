...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  ven. 24 août 2018 à 16:24
...
INSERT INTO `users` (`id`, `author`, `password`, `rank_id`) VALUES
...
--
ALTER TABLE `news`
  ADD CONSTRAINT `fk_user_id` FOREIGN KEY (`author_id`) REFERENCES `users` (`id`);
